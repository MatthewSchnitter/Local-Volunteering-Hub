...
//
//     final apiVolunteer = apiVolunteerFromJson(jsonString);

import 'dart:convert';

List<ApiVolunteer> apiVolunteerFromJson(String str) => List<ApiVolunteer>.from(json.decode(str).map((x) => ApiVolunteer.fromJson(x)));

String apiVolunteerToJson(List<ApiVolunteer> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class ApiVolunteer {
    ...
    factory ApiVolunteer.fromJson(Map<String, dynamic> json) => ApiVolunteer(
